...
public class SampleSauceTest implements SauceOnDemandSessionIdProvider {
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"OSX 10.9", "36", "firefox", "Mac 10.9 Firefox 36"});
    ...
    public void verifyTitleTest() throws Exception {
        driver.get("http://www.payless.com/");
        Thread.sleep(5000);
        assertEquals("Payless ShoeSource | Shoes, Boots, Sandals, Designer Shoes & Handbags", driver.getTitle());
    }
    ...
    public void loginTest() throws Exception {
        ...
        WebElement emailInput = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("email-input")));
